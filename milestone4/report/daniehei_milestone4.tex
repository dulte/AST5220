...
In fig. \ref{fig:theta_sq_k} we see that generally the scaled $l(l+1)\cdot \Theta_l/k$ seems to decrease for larger $l$, and have shapes similar to the damped harmonic oscillator of $\Theta_l$.
